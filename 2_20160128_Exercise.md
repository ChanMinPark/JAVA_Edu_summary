...
public class NameCardCLIApplication {
	...
	public static void listData() {
		if(count == 0){
			...
			for(int i=0; i<count ; i++) {
				System.out.printf("|\t"+nameCardList[i].name+"\t\t|\t"
							+nameCardList[i].email+"\t\t|\t"
							+nameCardList[i].age+"\t|\n");
			}
		}
	}
	...
	public static void updateData() {
		if(index != -1) {
			...
			System.out.print("이름을 입력하세요. : ");
			nameCardList[index].name = scan.next();
			System.out.print("이메일을 입력하세요. : ");
			nameCardList[index].email = scan.next();
			System.out.print("나이를 입력하세요. : ");
			nameCardList[index].age = scan.nextInt();
